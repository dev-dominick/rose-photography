            ...
            <div className="servicesInfo">
              ...
              <div className="servicePhoto">
                <img
                  ...
                  src={"https://rosephotography.b-cdn.net/giAndAubs%20(1).jpg"}
                  alt="Me at the beach"
                ></img>
              </div>
            ...
            <div className="servicesInfo">
                  ...
                  <div className="partyAndShowersHeaderContainer">
                    ...
                    <div className="partyAndShowersPhoto">
                      <img
                        className="profilePic"
                        src={
                          "https://rosephotography.b-cdn.net/babyShower%20(5).jpg"
                        }
                        alt="Me at the beach"
                      ></img>
                    </div>
                  ...
                  <div className="partyAndShowersHeaderContainer">
                    ...
                    <div className="partyAndShowersPhoto">
                      <img
                        className="profilePic"
                        src={
                          "https://rosephotography.b-cdn.net/philliesGame.jpg"
                        }
                        alt="Me at the beach"
                      ></img>
                    </div>
                ...
                <div className="pricingLayout">
                  ...
                  <p className="servicesText">
                    Full Album 75-100 photos - $350
                  </p>
                  <p className="servicesText">over 25 miles</p>
                  <p className="servicesText">
                    Full Album 75-100 photos - $375
                  </p>
                </div>
            </div>
          </section>
